...
def check_bomb_death(board, player, enemy2, enemy3, enemy4, bomb):
	score = 0
	playerdead = False
...
# Check if player comes in contact with enemy
	if check_contact_enemy(player_current, enemy2_current, enemy2) or check_contact_enemy(player_current, enemy3_current, enemy3) or check_contact_enemy(player_current, enemy4_current, enemy4):
...
# Check if player comes in contact with enemy
	...
	if enemy2.get_dead() == True and enemy3.get_dead() == True and enemy4.get_dead() == True:
		death(player)
		print("You win")
		break
# Bomb Logic
	...
	if bomb.get_frame() == 0 and bomb.get_exploded() == False:
		result = check_bomb_death(board, player, enemy2, enemy3, enemy4, bomb)
